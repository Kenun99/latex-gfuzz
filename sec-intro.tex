...
In this paper, we propose {\tool}\footnote{A kind of fecund rabbit, pronounced like py-k\textipa{@}}, the first parallel fuzzer to compile smart contracts to GPU executables and then test them on GPU to achieve a millions-level throughput.   
